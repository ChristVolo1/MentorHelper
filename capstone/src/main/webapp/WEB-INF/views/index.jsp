...
<section class="main-slider">
	<div id="home_slider_wrapper" class="rev_slider_wrapper fullscreen-container" >
		<div id="home_slider" class="rev_slider fullscreenbanner tiny_bullet_slider" data-version="5.4.1">
			<ul>	<!-- SLIDE  -->
				<li data-index="rs-73" 
				data-thumb="C:/Training/WS/capstoneMentorHelper/src/main/webapp/static/images/slider/Man_weedeating.jpg"
				...
				data-description="">
					<!-- MAIN IMAGE -->
					<img src="static/images/slider/Man_weedeating.jpg" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						data-frames='[{"delay":200,"speed":750,"sfxcolor":"#E68F3E","sfx_effect":"blockfromleft","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#ffffff","sfx_effect":"blocktoleft","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]'
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Connect with people. Get work done. </div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-74" 
					data-transition="fade" 
					...
					data-easeout="default" 
					data-masterspeed="300"  
					data-thumb="static/images/slider/Older_woman_helping_girl.jpg"  
					data-rotate="0"  
					data-saveperformance="off"  
					data-title="Slide">
					<!-- MAIN IMAGE -->
					<img src="static/images/slider/Older_woman_helping_girl.jpg" alt=""  
						data-bgposition="cover"
						data-bgfit="cover"
						data-bgrepeat="no-repeat"
						data-bgparallax="on" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						data-type="text" 
						data-responsive_offset="on" 
						data-frames='[{"delay":300,"speed":750,"sfxcolor":"#B65F67","sfx_effect":"blockfromright","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#ffffff","sfx_effect":"blocktoright","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]'
						...
						style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Share ideas. Enrich lives.
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-index="rs-75" 
					...
					data-easeout="default" 
					data-masterspeed="300" 
					data-thumb="images/slider/two_women_cooking.jpg"
					data-rotate="0"  
					data-saveperformance="off"  
					data-title="Slide" 
					data-param1="" 
					...
					data-description="">
					<!-- MAIN IMAGE -->
					<img src="static/images/slider/two_women_cooking.jpg"
					...
					<div class="tp-caption   tp-resizeme" 
						...
						data-type="text" 
						data-responsive_offset="on" 
						data-frames='[{"delay":200,"speed":750,"sfxcolor":"#058899","sfx_effect":"blockfromtop","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#ffffff","sfx_effect":"blocktotop","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]'
						...
						style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Share your skills with those who need it - Get help with your chores.</div>
				...
				<li data-index="rs-76" 
					...
					data-easeout="default" 
					data-masterspeed="300" 
					data-thumb="images/slider/grocery_shopping_with_mask.jpg"
					data-rotate="0"  
					data-saveperformance="off"  
					data-title="Slide" 
					data-param1="" 
					...
					data-description="">
					<!-- MAIN IMAGE -->
					<img src="static/images/slider/grocery_shopping_with_mask.jpg"
					data-bgposition="center center"
					data-bgfit="cover"
					data-bgrepeat="no-repeat" 
					data-bgparallax="on" 
					...
					<div class="tp-caption   tp-resizeme" 
						...
						data-type="text" 
						data-responsive_offset="on" 
						data-frames='[{"delay":200,"speed":750,"sfxcolor":"#0C5B3C","sfx_effect":"blockfrombottom","frame":"0","from":"z:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"sfxcolor":"#ffffff","sfx_effect":"blocktotop","frame":"999","to":"z:0;","ease":"Power4.easeOut"}]'
						data-textAlign="['center','center','center','center']"
						data-paddingtop="[20,20,20,20]"
						data-paddingright="[20,20,20,20]"
						data-paddingbottom="[30,30,30,30]"
						...
						style="z-index: 6; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px;font-family:Playfair Display;">Get the help you need.</div>
 

					<!-- LAYER NR. 11 goes here for shop-->
		...
		<div class="row">
			<div class="col-md-12">
				<div class="title text-center">
					<h2>Some of Our Collaborations</h2>
				</div>
			</div>
			<div class="col-md-6">
				<div class="category-box">
					<a href="">
						<img src="static/images/slider/Senior-artisan-making-bag.jpg" alt="" />
						<div class="content">
							<h3>Leatherworking Mentorship</h3>
				...
				<div class="category-box">
					<a href="">
						...
						<div class="content">
							...
							<p>Mentor/get help for younger people</p>
						</div>
					</a>	
				</div>
			</div>
			<div class="col-md-6">
				<div class="category-box category-box-2">
					<a href="">
						<img src="static/images/slider/helping_with_smartphone.jpg" alt="" />
						<div class="content">
							<h3>Tech Support</h3>
							<p>Help people learn and use technology</p>
						</div>
					</a>	
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="title">
					...
					<p>Stay up to date on our recent updates! Don't worry, we will never send spam.</p>
				</div>
